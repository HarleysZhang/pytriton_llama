# From : https://github.com/ModelTC/lightllm/blob/main/lightllm/models/llama/triton_kernel/context_flashattention_nopad.py
...
@torch.no_grad()
def context_attention_fwd_no_prompt_cache(q, k, v, b_start_loc, b_seq_len, max_input_len):
